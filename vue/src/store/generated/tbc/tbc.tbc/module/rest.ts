...
export type TbcMsgBuyCoinResponse = object;

export type TbcMsgInitSaleResponse = object;

/**
 * Params defines the parameters for the module.
 */
export type TbcParams = object;

export interface TbcQueryAllCreatorCoinResponse {
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryCreatorCoinAll
   * @summary Queries a list of CreatorCoin items.
   * @request GET:/tbc/tbc/creator_coin
   */
  queryCreatorCoinAll = (
    query?: {
      "pagination.key"?: string;
    ...
    this.request<TbcQueryAllCreatorCoinResponse, RpcStatus>({
      path: `/tbc/tbc/creator_coin`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   *
   * @tags Query
   * @name QueryCreatorCoin
   * @summary Queries a CreatorCoin by index.
   * @request GET:/tbc/tbc/creator_coin/{index}
   */
  queryCreatorCoin = (index: string, params: RequestParams = {}) =>
    this.request<TbcQueryGetCreatorCoinResponse, RpcStatus>({
      path: `/tbc/tbc/creator_coin/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
