...
import (
	...
	"tbc/docs"
	tbcmodule "tbc/x/tbc"
	tbcmodulekeeper "tbc/x/tbc/keeper"
	tbcmoduletypes "tbc/x/tbc/types"
...
var (
	...
	maccPerms = map[string][]string{
		...
		tbcmoduletypes.ModuleName:      {authtypes.Minter, authtypes.Burner, authtypes.Staking},
...
type App struct {
	*baseapp.BaseApp
	...
	TbcKeeper tbcmodulekeeper.Keeper
...
func New(
	...
	app.TbcKeeper = *tbcmodulekeeper.NewKeeper(
		appCodec,
		keys[tbcmoduletypes.StoreKey],
		keys[tbcmoduletypes.MemStoreKey],
		app.GetSubspace(tbcmoduletypes.ModuleName),

		app.BankKeeper,
	)
	tbcModule := tbcmodule.NewAppModule(appCodec, app.TbcKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(tbcmoduletypes.ModuleName)
